<template>
    <svg viewBox="0 0 128 128">
        ...
        <path class="fill-[var(--color-primary-800)] group-hover/angularjs:fill-[#F2F2F2] transition-colors duration-300 ease-in-out" d="M78.499 67.67l-14.827 6.934H48.044l-7.347 18.374-13.663.254 36.638-81.508L78.499 67.67zm-1.434-3.491L63.77 37.858 52.864 63.726h10.807l13.394.453z"/>
        <path class="fill-[var(--color-primary-900)] group-hover/angularjs:fill-[#B3B3B3] transition-colors duration-300 ease-in-out" d="M63.671 11.724l.098 26.134 12.375 25.888H63.698l-.027 10.841 17.209.017 8.042 18.63 13.074.242z"/>
    </svg>
</template>