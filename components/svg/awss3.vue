<template>
	<svg class=" transition-transform duration-300 ease-in-out group-hover/aws-s3:scale-110"viewBox="-27 0 310 310">
		<g>
			...
			<path class="fill-[var(--color-primary-500)] group-hover/aws-s3:fill-[#E05243] transition-colors duration-300 ease-in-out" d="M174.827,89.631 L127.996,78.045 L127.996,0 L174.827,23.413 L174.827,89.631"></path>
			<path class="fill-[var(--color-primary-600)] group-hover/aws-s3:fill-[#8C3123] transition-colors duration-300 ease-in-out" d="M127.996,309.428 L81.173,286.023 L81.173,219.806 L127.996,231.388 L128.685,232.171 L128.498,308.077 L127.996,309.428"></path>
			<path class="fill-[var(--color-primary-700)] group-hover/aws-s3:fill-[#E05243] transition-colors duration-300 ease-in-out" d="M127.996,309.428 L174.823,286.023 L174.823,219.806 L127.996,231.388 L127.996,309.428"></path>
			<path class="fill-[var(--color-primary-800)] group-hover/aws-s3:fill-[#E05243] transition-colors duration-300 ease-in-out" d="M235.367,53.686 L256,64 L256,245.02 L235.367,255.33 L235.367,53.686"></path>
		</g>
	</svg>
</template>