<template>
    <svg viewBox="0 0 128 128" :class="hoverable ? 'fill-[var(--color-primary-500)] group-hover/django:fill-[#092e20] transition-all group-hover/django:scale-110 duration-300 ease-in-out' : 'fill-[var(--color-white)]/80'">
