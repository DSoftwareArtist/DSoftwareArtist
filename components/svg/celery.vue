<template>
    <svg :class="hoverable ? 'transition-transform duration-300 ease-in-out group-hover/celery:scale-110 fill-[var(--color-primary-500)] group-hover/celery:fill-[#308030]' : 'fill-[var(--color-white)]'" viewBox="0 0 24 24">
