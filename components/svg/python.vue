<template>
    <svg class=" transition-transform duration-300 ease-in-out group-hover/android:scale-110"viewBox="0 0 512 512">
        <g class="fill-[var(--color-primary-500)] group-hover/python:fill-[#5a9fd4] transition-colors duration-500 ease-in-out">
