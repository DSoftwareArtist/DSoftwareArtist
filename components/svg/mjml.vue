<template>
    <svg class=" transition-transform duration-300 ease-in-out group-hover/android:scale-110"viewBox="0 0 32 32">
        ...
        <path class="fill-[var(--color-primary-700)] group-hover/mjml:fill-[#f75d3c] transition-colors duration-300 ease-in-out" d="M18.212,19.481a6.792,6.792,0,0,1,1.449-.083c2.946.007,5.894,0,8.84.005a2.439,2.439,0,1,1,.11,4.877h-.121c-3.229,0-6.458.007-9.687,0a2.4,2.4,0,0,1-2.382-2.209A2.433,2.433,0,0,1,18.212,19.481Z"/>
        <path class="fill-[var(--color-primary-800)] group-hover/mjml:fill-[#f75d3c] transition-colors duration-300 ease-in-out" d="M11.9,26.181a5.528,5.528,0,0,1,.99-.059c3.11.012,6.219-.005,9.328.008a2.444,2.444,0,0,1,2.387,2.5l0,.053a2.478,2.478,0,0,1-2.4,2.323q-4.915.005-9.83,0a2.441,2.441,0,0,1-.473-4.82Z"/>
        <path class="fill-[var(--color-primary-800)] group-hover/mjml:fill-[#f75d3c] transition-colors duration-300 ease-in-out" d="M27.71,26.238a2.525,2.525,0,0,1,3.126,1.455,2.482,2.482,0,1,1-4.82.826A2.388,2.388,0,0,1,27.71,26.238Z"/>
