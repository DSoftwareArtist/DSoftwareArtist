...
<template>
  <div
    class="relative group overflow-hidden rounded-xl border border-primary-800 bg-primary-600/20 shadow-sm transition-all duration-300 min-h-[200px] backdrop-blur-[4px]"
