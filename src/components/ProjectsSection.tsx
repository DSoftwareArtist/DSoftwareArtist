...
import { MapPin, BarChart3, Bot, ExternalLink } from "lucide-react";
...
const projects = [
  {
    ...
    desc: "A geolocation-based mobile game helping users discover hidden rewards using real-time maps.",
    tags: ["Leaflet", "Django", "PostgreSQL"],
    status: "COMPLETED",
  },
  {
    icon: BarChart3,
    title: "Land Investment Analysis Tool",
    desc: "Python & Django app analyzing sold parcels to identify investment patterns and opportunities.",
    tags: ["Python", "GeoDjango", "Pandas"],
    status: "COMPLETED",
  },
  {
    icon: Bot,
    title: "Web Automation Bots",
    desc: "Python & Playwright scripts that scrape and automate repetitive tasks efficiently.",
    tags: ["Python", "Playwright", "APIs"],
    status: "ACTIVE",
  },
];
